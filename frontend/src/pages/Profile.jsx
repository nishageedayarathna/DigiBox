    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {(profile.role === "gs" || profile.role === "ds") && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Administrative Details</h2>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {profile.divisionCode && (
                <div>
                  <label className="block text-gray-600 text-sm mb-1">Division</label>
                  <p className="text-gray-800 font-medium">
              ...
              {profile.areaCode && (
                <div>
                  <label className="block text-gray-600 text-sm mb-1">Area</label>
                  <p className="text-gray-800 font-medium">
